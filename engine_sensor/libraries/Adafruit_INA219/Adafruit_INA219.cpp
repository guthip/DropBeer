...
/**************************************************************************/
/*!
 @brief  Configures to INA219 to be able to measure up to 16V and 160A
 of current.
 
 @note   These calculations assume a 0.00075 ohm resistor is present
 */
/**************************************************************************/
void Adafruit_INA219::setCalibration_16V_160A(void) {
    
    ina219_calValue = 32768; //8192
    ina219_currentDivider_mA = 320;    // Current LSB = 50uA per bit (1000/50 = 20)
//   ina219_currentDivider_mA = 200;    // Current LSB = 50uA per bit (1000/50 = 20)
    ina219_powerMultiplier_mW = 0.10f; // Power LSB = 1mW per bit
